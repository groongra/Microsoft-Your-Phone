...
MEDIA_QUERY = "SELECT name, last_updated_time, taken_time, last_seen_time, orientation, mime_type, height, width, size,	uri, thumbnail,	media, checksum FROM media" # subscription_iD, checksum
...
SMS_QUERY = "thread_id, from_address, type, timestamp, status, pc_status, body"  # subject
